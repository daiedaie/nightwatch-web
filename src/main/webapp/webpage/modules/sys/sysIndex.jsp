...
<head>
	...
	<script src="${ctxStatic}/jquery-cookie/jquery.cookie.js"></script>
	<!-- 菜单插件 -->
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-top:-9px;margin-bottom:-15px;height: 35px;">
                    <div class="navbar-header">
                    	<a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i></a>
                    </div>
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#" style="height: 50px;">
                                <i class="fa fa-bell"></i> <span class="label label-primary" id="undealTrigger"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-alerts">
                                <li id="undealTriggerList"></li>
                                <li class="divider"></li>
                                <li id="undealTriggerTotal">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/trigger/home" frameborder="0" data-id="${ctx}/home" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-center"><a href="http://rtc.jzsec.com">http://rtc.jzsec.com</a> &copy; 2015-2025</div>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
